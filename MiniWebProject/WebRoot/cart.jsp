...
<html>
	<head>
		<title>Shopping Cart | Welcome To Lightning.net</title>
                                       ...
                                       <div class="left-bot-corner maxheight">
                                          <div class="inner">
											...
											<form method="post" action="./cart">
											  ...
											  <p><strong>Product Status </strong>(1 means having bought and 2 means adding into shopping chart): <%=cart.getStatus() %></p>
											  <div class="move">
												  <button type="submit" name="add" value=<%=cart.getCartID()%>>Add</button>
												  <button type="submit" name="minus"  value=<%=cart.getCartID()%>>Minus</button>
												  <button type="submit" name="drop"  value=<%=cart.getCartID()%>>Drop</button>
												  <button type="submit" name="buy"  value=<%=cart.getCartID()%>>Buy</button>
											 	  <input type="hidden" name="<%=cart.getCartID()%>price" value=<%=cart.getPrice()%>>
												  <input type="hidden" name="<%=cart.getCartID()%>proName" value=<%=cart.getProName()%>>
												  <input type="hidden" name="<%=cart.getCartID()%>picture" value=<%=cart.getPicture()%>>
												  <input type="hidden" name="<%=cart.getCartID()%>number" value=<%=cart.getNumber()%>>
											  </div>
											  </form>
											 <%}
											 } %>
