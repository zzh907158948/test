...
//Sort an array's value into ascending order
import java.awt.*;
...
public class BubbleSort extends JApplet {
	public void init(){
		...
		//append original array value to String output
	...
	public void bubbleSort(int array2[]){
	  ...
	  //loop to control number of comparisons
		 for (int element = 0; element < array2.length-1; element++) {
			...
			//compare side-by-side elements and swap them if first element is greater than the second element
